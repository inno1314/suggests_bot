...
@router.callback_query(BotSettings.change, F.data.in_(["start_msg_formatting", "answer_msg_formatting", "post_formatting"]))
...
@router.callback_query(BotSettings.formatting,
                       F.data.in_(["clear_start_msg_formatting", "clear_answer_msg_formatting", "clear_post_formatting"]))
async def delete_formatting(call: types.CallbackQuery, state: FSMContext,
    ...
    await db.bot_api.update_bot_field(session, bot_id,
                                      db_fields[formatting_field], None)
...
async def set_new_formatting(message: types.Message, state: FSMContext,
    ...
    await db.bot_api.update_bot_field(session, bot_id,
                                      db_fields[formatting_field], new_formatting)
