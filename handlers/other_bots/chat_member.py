...
async def bot_added_to_channel(event: types.ChatMemberUpdated, session: AsyncSession,
                             bot: Bot):
    """
...
async def bot_deleted_from_channel(event: types.ChatMemberUpdated, session: AsyncSession,
                             bot: Bot):
    """
